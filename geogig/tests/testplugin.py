...
def functionalTests():
    ...
    test.addStep("Open navigator",  _openNavigator)
    test.addStep("Select the 'master' branch in the repository explorer. Pull the 'master' branch from 'myremote' remote. Verify the pull operation is performed correctly.")
    tests.append(test)
    
    test = Test("Pull to different branch")
    test.addStep("New project", iface.newProject)
    test.addStep("Prepare test", _createPullScenario)
    test.addStep("Open navigator",  _openNavigator)
    test.addStep("Select the 'mybranch' branch in the repository explorer. Pull the 'master' branch from 'myremote' remote. Verify the pull operation is performed correctly.")
    tests.append(test)
    ...
    test.addStep("Open navigator",  _openNavigator)
    test.addStep("Select the 'master' branch in the repository explorer. Push to 'master' branch in 'myremote' repo . Verify the push operation is performed correctly.")
    tests.append(test)
    ...
    test.addStep("Open navigator",  _openNavigator)
    test.addStep("Select the 'master' branch in the repository explorer. Pull the 'master' branch from 'myremote' remote. It will warn you of existing conflict. Solve conflicts and verify it finishes the pull operation correctly.")
    tests.append(test)
    ...
    test.addStep("Open navigator",  _openNavigator)
    test.addStep("Select the 'master' branch in the repository explorer. Push to the 'master' branch in the 'myremote' repo . Verify the push operation is not performed and the corresponding message is displayed.")
    tests.append(test)
